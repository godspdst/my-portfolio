...
const PROJECTS = [
  { id:"jd-work-queue-follow-up-date",   img:"/images/jd-imac-mockup.png",              title:"john deere work queue",           cat:"enterprise ux", pos:"center 48%", scale:1.4 },
  { id:"jd-credit-hub-guarantor",        img:"/images/jd-imac-mockup.png",              title:"john deere credit hub — guarantor", cat:"enterprise ux", pos:"center 48%", scale:1.4 },
                  ...
                  <a key={p.id} href={`/case-study/${p.id}`} className="top5-link"
                    ...
                    <span style={{display:"block",height:"130px",position:"relative",border:`1.5px solid ${C.ink}`,borderRadius:"8px",overflow:"hidden"}}>
                      <img src={p.img} alt={p.title}
                        style={{width:"100%",height:"100%",objectFit:"cover",objectPosition:p.pos||"center center",display:"block",transform:p.scale?`scale(${p.scale})`:"none",transformOrigin:"center center",filter:"sepia(0.7) contrast(1.05) brightness(0.96)"}}
                      />
                    </span>

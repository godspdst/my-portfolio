...
const PROJECTS = [
  { id:"jd-work-queue-follow-up-date",  cls:"pc-deere", logoClass:"jd-logo", wmColor:C.paper, bg:C.ink,  logoPath:JD_PATH, title:"john deere work queue",             cat:"enterprise ux", num:"01" },
  { id:"jd-credit-hub-guarantor",       cls:"pc-deere", logoClass:"jd-logo", wmColor:C.paper, bg:C.blue, logoPath:JD_PATH, title:"john deere credit hub — guarantor",  cat:"enterprise ux", num:"02" },
        ...
        <div style={{display:"flex",flexDirection:"column",gap:"24px"}}>
          ...
          <div style={{border:`1.5px solid ${C.ink}`,borderRadius:"12px",overflow:"hidden",background:C.card}}>
            ...
            <div style={{padding:"22px 24px",display:"flex",flexDirection:"column",gap:"14px",fontSize:"15.5px",lineHeight:1.65}}>
              <p style={{margin:0}}>I'm Stephanie, a product designer and data nerd. I've been designing on the internet since I was 13, because my MySpace profile didn't look as cool as the other kids'. I turn messy data into products people can use no matter their technology comfortability: fintech workflows, enterprise financial tools and complex internal systems. I've worked with startups, agencies and Fortune 500s.</p>
